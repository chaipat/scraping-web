...
<body>
    <div class="container">
    <h1>Scraping thainews</h1>
<?php
include_once('../simple_html_dom.php');

// $get_data_url = 'https://www.thainewsonline.co/';
// $get_data_url = 'https://www.thainewsonline.co/lottory/thai-lottery/851711';
...
if(isset($_POST['thainews_url'])){

    $url = $_POST['thainews_url'];
}else{
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" name="thainews_url" value="'.$url.'" placeholder="ex. https://www.thainewsonline.co/lottory/thai-lottery/851711">
</div>
<div class="mb-3">
    <label for="folder" class="form-label">folder</label>
    <input type="text" class="form-control" name="folder" value="'.$folder.'" placeholder="ex. 851711">
</div>
<button type="submit" class="btn btn-primary mb-3">Submit</button>
<hr>
</form>';

$folder = 'thainews-'.$folder;
...
// find all image
echo "Image<br>";
foreach($html->find('div.detail-content img') as $e){
    if(trim($e->src) != ''){
...
foreach($html->find('div#contents div#section-1') as $e){
    // echo $e->plaintext . '<br>';
    echo $e->innertext . '<br>';
    $item['content'] .= $e->plaintext;
}

foreach($html->find('div#contents div#section-2') as $e){
    // echo $e->plaintext . '<br>';
    echo $e->innertext . '<br>';
    $item['content'] .= $e->plaintext;
}

foreach($html->find('div#contents div#section-3') as $e){
    // echo $e->plaintext . '<br>';
    echo $e->innertext . '<br>';
    $item['content'] .= $e->plaintext;
}
