...
<html lang="th">
	...
	<title>Check Category thainews</title>
    ...
    <div class="container1" >
        ...
        <table id="table-list" width="98%" class="table-concept">
            ...
            <tr>
                <td>Home</td>
                <td></td>
                <td id="url0">https://www.thainewsonline.co/</td>
...
function init_cat(){
    var url = 'https://api.thainewsonline.co/api/v1.0/navigations/menu-nav';
    var base_url = 'https://www.thainewsonline.co/';
    var sub;
    var nameTh;
    var catid;
    var link;
        ...
        success:function(rsponse){
            ...
            for(var k in rsponse) {
                ...
                for(var j in sub) {
                    ...
                    curlink = 'https://www.thainewsonline.co' + link;
