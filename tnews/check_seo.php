...
<body>
    <div class="container">
    <h1>Scraping tnews</h1>
<?php
include_once('../simple_html_dom.php');

// $get_data_url = 'https://www.tnews.co.th/';
// $get_data_url = 'https://www.tnews.co.th/entertainment/thai-entertainment/588683';
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" name="tnews_url" value="'.$url.'" placeholder="ex. https://www.tnews.co.th/entertainment/thai-entertainment/588683">
</div>
<div class="mb-3">
    <label for="folder" class="form-label">folder</label>
    <input type="text" class="form-control" name="folder" value="'.$folder.'" placeholder="ex. 588683">
</div>
...
// find all image
echo "Image<br>";
foreach($html->find('div.article-content div.default-inread img') as $e){
    if(trim($e->src) != ''){
