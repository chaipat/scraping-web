...
<html lang="th">
	...
	<title>Check Category tnews</title>
    ...
    <div class="container1" >
        ...
        <table id="table-list" width="98%" class="table-concept">
            ...
            <tr>
                <td>Home</td>
                <td></td>
                <td id="url1">https://www.tnews.co.th/</td>
...
function init_cat(){
    var url = 'https://api.tnews.co.th/api/v1.0/navigations/menu-nav';
    var base_url = 'https://www.tnews.co.th/';
    var sub;
    var nameTh;
    var catid;
    var link;
        ...
        success:function(rsponse){
            ...
            for(var k in rsponse) {
                ...
                for(var j in sub) {
                    ...
                    curlink = 'https://www.tnews.co.th' + link;
