...
<html lang="th">
	...
	<title>Check Category nationtv</title>
    ...
    <div class="container1" >
        ...
        <table id="table-list" width="98%" class="table-concept">
            ...
            <tr>
                <td>Home</td>
                <td></td>
                <td id="url0">https://nationtv.tv/</td>
...
function init_cat(){
    var url = 'https://api.nationtv.tv/api/v1.0/navigations/menu-nav';
    var base_url = 'https://nationtv.tv/';
    var sub;
    var nameTh;
    var catid;
    var link;
        ...
        success:function(rsponse){
            ...
            for(var k in rsponse) {
                ...
                for(var j in sub) {
                    ...
                    curlink = 'https://www.nationtv.tv' + link;
