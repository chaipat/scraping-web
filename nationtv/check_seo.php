...
<body>
    <div class="container">
    <h1>Scraping nationtv</h1>
<?php
include_once('../simple_html_dom.php');

// $get_data_url = 'https://www.nationtv.tv/';
// $get_data_url = 'https://www.nationtv.tv/news/region/378913547';
...
if(isset($_POST['nationtv_url'])){

    $url = $_POST['nationtv_url'];
}else{
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" name="nationtv_url" value="'.$url.'" placeholder="ex. https://www.nationtv.tv/news/region/378913547">
</div>
<div class="mb-3">
    <label for="folder" class="form-label">folder</label>
    <input type="text" class="form-control" name="folder" value="'.$folder.'" placeholder="ex. 378913547">
</div>
<button type="submit" class="btn btn-primary mb-3">Submit</button>
<hr>
</form>';

$folder = 'nationtv-'.$folder;
