...
<html lang="th">
	...
	<title>Check Category posttoday</title>
...
<body>
    <div class="container1" >
        <h1>Check Category posttoday</h1>
        ...
        <table id="table-list" width="98%" class="table-concept">
            ...
            <tr>
                <td>Home</td>
                <td></td>
                <td id="url0">https://www.posttoday.com/</td>
...
function init_cat(){
    var url = 'https://api.posttoday.com/api/v1.0/navigations/menu-nav';
    var base_url = 'https://www.posttoday.com/';
    var sub;
    var nameTh;
    var catid;
    var link;
        ...
        success:function(rsponse){
            ...
            for(var k in rsponse) {
                ...
                for(var j in sub) {
                    ...
                    curlink = 'https://www.posttoday.com' + link;
