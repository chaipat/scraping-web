...
<html lang="th">
	...
	<title>Check Category springnews</title>
...
<body>
    <div class="container1" >
        <h1>Check Category springnews</h1>
        ...
        <table id="table-list" width="98%" class="table-concept">
            ...
            <tr>
                <td>Home</td>
                <td></td>
                <td id="url1">https://www.springnews.co.th/</td>
...
function init_cat(){
    var url = 'https://api.springnews.co.th/api/v1.0/navigations/menu-nav';
    var base_url = 'https://www.springnews.co.th/';
    var sub;
    var nameTh;
    var catid;
    var link;
        ...
        success:function(rsponse){
            ...
            for(var k in rsponse) {
                ...
                for(var j in sub) {
                    ...
                    curlink = 'https://www.springnews.co.th' + link;
