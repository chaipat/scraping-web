...
<html lang="th">
	...
	<title>Scraping springnews</title>
...
<body>
    <div class="container">
    <h1>Scraping springnews</h1>
<?php
include_once('../simple_html_dom.php');

// $get_data_url = 'https://www.springnews.co.th/';
// $get_data_url = 'https://www.springnews.co.th/news/838073';
...
if(isset($_POST['spring_url'])){

    $url = $_POST['spring_url'];
}else{
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" name="spring_url" value="'.$url.'" placeholder="ex. https://www.springnews.co.th/news/838073">
</div>
<div class="mb-3">
    <label for="folder" class="form-label">folder</label>
    <input type="text" class="form-control" name="folder" value="'.$folder.'" placeholder="ex. 838073">
</div>
<button type="submit" class="btn btn-primary mb-3">Submit</button>
<hr>
</form>';

$folder = 'springnews-'.$folder;
...
// find all image
echo "Image<br>";
foreach($html->find('div#contents div.content-detail img') as $e){
    if(trim($e->src) != ''){
