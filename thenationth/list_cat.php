...
<html lang="th">
	...
	<title>Check Category TheNationTH</title>
...
<body>
    <div class="container1" >
        <h1>Check Category TheNationTH</h1>
        ...
        <table id="table-list" width="98%" class="table-concept">
            ...
            <tr>
                <td>Home</td>
                <td></td>
                <td id="url0">https://www.nationthailand.com/</td>
...
function init_cat(){
    var url = 'https://api.nationthailand.com/api/v1.0/navigations/menu-nav';
    var base_url = 'https://www.nationthailand.com/';
    var sub;
    var nameTh;
    var catid;
    var link;
        ...
        success:function(rsponse){
            ...
            for(var k in rsponse) {
                ...
                for(var j in sub) {
                    ...
                    curlink = 'https://www.nationthailand.com' + link;
