...
<html lang="th">
	...
	<title>Check Category khobsanam</title>
...
<body>
    <div class="container1" >
        <h1>Check Category khobsanam</h1>
        ...
        <table id="table-list" width="98%" class="table-concept">
            ...
            <tr>
                <td>Home</td>
                <td></td>
                <td id="url0">https://www.khobsanam.com</td>
...
function init_cat(){
    var url = 'https://api.khobsanam.com/api/v1.0/navigations/menu-nav';
    var base_url = 'https://www.khobsanam.com/';
    var sub;
    var nameTh;
    var catid;
    var link;
        ...
        success:function(rsponse){
            ...
            for(var k in rsponse) {
                ...
                for(var j in sub) {
                    ...
                    subcatid = sub[j].id;
                    nameTh = sub[j].nameTh;
                    link = sub[j].link.trim();

                    curlink = 'https://www.khobsanam.com' + link;
