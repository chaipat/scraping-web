...
$get_data_url = 'https://www.goal.co/webboard/index.php?menu=topic&id=112592';
...
foreach($html->find('div.tabs-webboard') as $e){
    $item['description'] = $e->innertext;
}

// echo "<hr>";
// find all image
// echo "Image<br>";
foreach($html->find('div.inner-webboard div.topic-content img') as $e){
    if(trim($e->src) != ''){
...
// find content
// echo "Content<br>";
foreach($html->find('div.inner-webboard div.topic-content') as $e){
    // echo $e->plaintext . '<br>';
    // echo $e->innertext . '<br>';
...
if($item){
    ...
    $location_txt = 'image/'.$folder.'/goal-detail.txt';
