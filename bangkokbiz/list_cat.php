...
<html lang="th">
	...
	<title>Check Category bangkokbiz</title>
...
<body>
    <div class="container1" >
        <h1>Check Category bangkokbiz</h1>
...
function init_cat(){
    var url = 'https://api.bangkokbiznews.com/api/v1.0/navigations/menu-nav';
    var base_url = 'https://www.bangkokbiznews.com/';
    var sub;
    var nameTh;
    var catid;
    var link;
        ...
        success:function(rsponse){
            ...
            for(var k in rsponse) {
                ...
                for(var j in sub) {
                    ...
                    curlink = 'https://www.bangkokbiznews.com' + link;
